...
export default function AddVideo() {
  ...
  return (
    <Container>
      <FormularioTitulo>Registrar Video</FormularioTitulo>
        ...
        <ElementosFormulario>
          ...
          <CajaInputs>
            <ContainerInput>
              <CustomTextInput
                ...
                name="embedId"
                placeholder="Escribe el id de la url de youtube. Ej:fAe3flSji_A"
                register={register}
          ...
          <CajaInputs>
            <ContainerInput>
              <CustomTextInput
                type="text"
                label="EMBED ID DE LA IMAGEN"
                name="img"
                placeholder="El mismo id: fAe3flSji_A"
                register={register}
                error={errors.img}
              />
              {errors.img ? (
          ...
          <CajaInputs>
            <ContainerInput>
              <TextoLabel>ELIGE UNA CATEGORIA</TextoLabel>
              <Select
